...
const beliefs = [
  ...
  { title: "Built by doing, not by degree.", body: "No agency pedigree. I learned by shipping real products for real businesses — and the list keeps growing. That's the unconventional angle, and I own it." },
];
